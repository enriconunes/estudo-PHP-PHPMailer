				...
				<div class="card-body font-weight-bold">
					<form action="processa_envio.php" method="post">
						<div class="form-group">
							...
							<input type="email" class="form-control" id="para" name="para" placeholder="joao@dominio.com.br">
						</div>
						...
						<?php
						// isset confere se possui 'login' definido na url
						if (isset($_GET['acesso']) && $_GET['acesso'] == 'negado') {
						?>

							<div class=text-danger>Preecha os campos corretamente!</div>
